...
type Band = { index: string; name: string; caption: string; items: Skill[] };
const layers: Band[] = [
  {
    index: '01',
    name: 'Interface',
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: 'Schema design',
        note: 'I like to think through the model first.',
      },
    ],
  },
];
const rails: Band[] = [
  {
    ...
    items: [
      {
        name: 'JavaScript',
        note: 'Client logic, utilities, and interaction handling.',
      },
      {
        name: 'TypeScript',
        note: 'Used here and in most structured React work.',
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: 'Docker',
        note: 'When I want the setup to behave the same everywhere.',
      },
    ],
  },
];
    ...
    <div className="grid gap-5 py-8 md:grid-cols-[minmax(0,14rem)_1fr] md:gap-10 md:py-10">
      ...
      <div className="md:pt-1">
        ...
        <div className="flex items-baseline gap-3">
          {' '}
          <span className="text-meta uppercase tracking-[0.2em] text-ember">
            {' '}
            {band.index}{' '}
          </span>{' '}
        ...
        <p className="mt-2 text-small leading-6 text-white/55">
          {band.caption}
        </p>{' '}
      </div>{' '}
      <div>
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isActive
                    ? 'border-white bg-white text-basalt'
        ...
        >
          ...
          <div className="overflow-hidden">
            {' '}
            <p className="border-l border-ember/45 pl-4 text-small leading-6 text-white/70">
              {' '}
              {activeItem?.note}{' '}
            </p>{' '}
          </div>{' '}
...
export default function Skills() {
  ...
  return (
    <section
      id="skills"
      className="section-padding relative isolate overflow-hidden bg-basalt text-white"
    >
      {' '}
      <div
        aria-hidden="true"
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -left-40 top-1/4 h-120 w-120 rounded-full bg-ember/6 blur-3xl"
      />
      <div className="container-tight relative z-10">
        <div className="max-w-2xl">
          <div className="mb-5 flex items-center gap-4">
            <span className="h-px w-10 bg-ember/60" />
            <span className="text-meta font-medium uppercase tracking-[0.2em] text-ember">
              Toolbox
            </span>
          </div>
          ...
          <p className="mt-5 max-w-xl text-body leading-7 text-white/60">
            I keep the stack small and practical. Read it as one system: what
            the user touches, what decides the rules, and what has to still be
            true tomorrow.
          </p>
        </div>
        ...
        <p className="mt-10 text-meta uppercase tracking-[0.2em] text-white/60">
