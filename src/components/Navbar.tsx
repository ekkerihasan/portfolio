  ...
  return (
    <div className="fixed top-4 left-1/2 z-50 w-[min(90vw,1180px)] -translate-x-1/2 pointer-events-none">
      <motion.nav
        ...
        className="pointer-events-auto rounded-3xl border border-black/5 bg-white/55 backdrop-blur-[20px] shadow-[0_16px_40px_rgba(17,17,17,0.06)]"
      >
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              exit={{ opacity: 0, y: -8 }}
              className="border-t border-black/5 px-4 pb-4 pt-3 md:hidden"
            >
